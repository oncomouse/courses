...
Our course shell is located on [A&M's Canvas site](https://canvas.tamu.edu).
...
Our Microsoft Teams site is linked on [Canvas](https://canvas.tamu.edu).

### Course Blog

The course is posted at [https://oncomouse.github.io/460blog](https://oncomouse.github.io/460blog).

It will be used for:

1. [Your individual recaps of previous posts](#semesterly-blog-recap)
...
Each week, after completing the assigned reading, you will be given an activity designed to help you apply what you have learned. The results of these activities will be posted to your Jekyll blog. Instructions for each weekly activity will be linked on the [schedule](#schedule).

For a refresher on posting to your blog, see ["Posting To Your Jekyll Blog"](#posting-to-your-jekyll-blog) above.
